...
public class ProductsController : ControllerBase
{
  ...
  public async Task<IActionResult> AddProduct([FromBody] ProductDefinition productDefinition)
  {
    ...
    await _mediator.Send(new Commands.AddProduct(id, productDefinition.Name, productDefinition.Description));

    return Accepted(new { ProductId = id });
  }
  ...
  public async Task<IActionResult> UpdateProduct(
    ...
    [FromBody] ProductPatchDefinition productPatchDefinition)
  {
    var product = await _productsRepository.GetProduct(productId);
    ...
    await _mediator.Send(new Commands.UpdateProduct(productId, productPatchDefinition.Name, productPatchDefinition.Description));
